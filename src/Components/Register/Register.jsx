...
export default function Register() {
  ...
  if (Object.keys(errors).length === 0) {
    ...
    const urls = `http://127.0.0.1:8000/api/signup`;
    try {
    ...
    <section className="mt-10">
      <div className="container h-full px-6 py-24">
        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-6/12 nanda">
            <img
...
<TEInput
              ...
              <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                  ...
                  <a
                    href="/"
                    className={`text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700 text-indigo-500 hover:text-indigo-700`}
                    >
                    Login
                  </a>
                </p>
              ...
              {/* <TERipple rippleColor="light" className="w-full">
                <button
                  type="submit"
                  //onClick={()=>{console.log("nanda anumolu")}}
                  // onMouseDown={() => { console.log("nanda anumolu") }}
                  onMouseDown={(e) =>  handleRegister(e) }
